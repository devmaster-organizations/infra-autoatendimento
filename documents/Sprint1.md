...
|----------|-----------------------------------------------------------------------------------|-----------|------------|--------|----------------|
| **S1-01**  | INF-01.1 – Configurar repositório, estrutura de pastas e TypeScript               |           |            | 1      | INF-01         |
| **S1-02**  | INF-01.2 – Configurar Docker Compose (PostgreSQL, Backend, Frontend)              |           |            | 1      | INF-01         |
| **S1-03**  | BD-01.1 – Criar diagrama MER/DER do banco de dados                                |           |            | 1      | BD-01          |
| **S1-04**  | BD-01.2 – Criar extensão pgcrypto, enums e tabela `users` com migration           |           |            | 1      | BD-01          |
| **S1-05**  | BD-01.3 – Criar tabela `navigation_nodes` e migration                             |           |            | 1      | BD-01          |
| **S1-06**  | BD-01.4 – Criar tabelas `questions`, `interaction_logs`, `satisfaction_ratings`   |           |            | 1      | BD-01          |
| **S1-07**  | BD-01.5 – Mapear enums, índices e `updated_at` automático no Prisma               |           |            | 1      | BD-01          |
| **S1-08**  | RF01.1 – Criar endpoints GET de navegação (`/tree` e `/:slug`)                    |           |            | 1      | RF01           |
| **S1-09**  | RF02.1 – Criar endpoint GET de consulta ao repositório de conhecimento            |           |            | 1      | RF02           |
| **S1-10**  | RF03.1 – Criar endpoint `POST /auth/login` com geração de JWT                     |           |            | 1      | RF03 / RF09    |
| **S1-11**  | RF03.2 – Implementar hash de senha com bcrypt e variáveis de ambiente             |           |            | 1      | RF03 / RF09    |
| **S1-12**  | RF10.1 – Criar middlewares de autenticação JWT e autorização por role             |           |            | 1      | RF10 / RF11    |
| **S1-13**  | RF06.1 – Criar endpoints GET de perguntas (listagem e busca por ID)               |           |            | 1      | RF06           |
| **S1-14**  | INF-02.1 – Conectar Swagger ao backend e configurar Jest                          |           |            | 1      | INF-02         |
| **S1-15**  | ARQ-01.1 – Criar e entregar Diagrama de Casos de Uso                              |           |            | 1      | ARQ-01         |
| **S1-16**  | TESTE-02.1 – Teste unitário de RF09: Autenticar-se no sistema                     |           |            | 1      | TESTE-02       |
| **S1-17**  | TESTE-02.2 – Teste unitário de RF11: Validar token de acesso                      |           |            | 1      | TESTE-02       |
...
|----------|-----------------------------------------------------------------------------------------------------------------------------------------|-----------|------------|--------|
| **G-01** | **Scrum Master:** Facilitar cerimônias ágeis (Daily, Planning, Review, Retrospective), acompanhar impedimentos, garantir comunicação eficaz e apoiar a equipe na aplicação do DoD. |           |            | 1      |
| **G-02** | **Product Owner:** Refinar e priorizar backlog, alinhar requisitos com stakeholders, validar entregas nas reviews e garantir clareza nos critérios de aceitação.                 |           |            | 1      |
...
|--------------------------------------|--------|--------|--------|--------|---------------------|---------------------|--------|
| **Victor Ramos (SM)**                | G-01   | G-01   | G-01   | G-01   | S1-01/S1-00         | S1-02/S1-08         | G-01   |
